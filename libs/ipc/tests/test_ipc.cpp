...
TEST(ipc_message_type_constants) {
    ...
    ASSERT_EQ(ipc::MessageType::VfsMkdir, (u32)5);
    ASSERT_EQ(ipc::MessageType::MouseRead, (u32)12);
    ASSERT_EQ(ipc::MessageType::AtaRead, (u32)13);
    ASSERT_EQ(ipc::MessageType::NsListAll, (u32)15);
}
