...
KeyCode Keyboard::resolveShift(KeyCode key) {
    ...
    case KeyCode::LeftBracket:
        return KeyCode::LeftCurly;
    case KeyCode::RightBracket:
        return KeyCode::RightCurly;
    ...
    case KeyCode::Comma:
        return KeyCode::LessThan;
    case KeyCode::Period:
        return KeyCode::GreaterThan;
    case KeyCode::Slash:
...
Keyboard::Keyboard()
    : shift_held(false), ctrl_held(false), alt_held(false), caps_lock_on(false), e0_prefix(false),
