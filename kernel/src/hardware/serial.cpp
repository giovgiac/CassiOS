...
Serial COM1::instance(PortType::SerialCOM1Data, PortType::SerialCOM1InterruptEnable,
                      PortType::SerialCOM1FIFOControl, PortType::SerialCOM1LineControl,
                      PortType::SerialCOM1ModemControl, PortType::SerialCOM1LineStatus);
...
Serial::Serial(PortType data, PortType interrupt_enable, PortType fifo_control,
    ...
    : data(data), interrupt_enable(interrupt_enable), fifo_control(fifo_control),
      line_control(line_control), modem_control(modem_control), line_status(line_status) {
