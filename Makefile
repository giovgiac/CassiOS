...
objects = loader.o gdt.o shell.o driver.o port.o terminal.o stub.o interrupt.o keyboard.o mouse.o kernel.o

# Shared objects for the test kernel (everything except kernel.o)
shared_objects = loader.o gdt.o shell.o driver.o port.o serial.o terminal.o stub.o interrupt.o keyboard.o mouse.o
